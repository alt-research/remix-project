...
export function EnvironmentUI(props: EnvironmentProps) {
  ...
  const findProvider = props.providers.providerList.find(
    (exEnv) => exEnv.value === props.selectedEnv
  );

  const currentProvider =
    findProvider === undefined ? props.providers.providerList[0] : findProvider;
        ...
        {findProvider === undefined
          ? setTimeout(() => {
              props.setExecutionContext({
                context: props.providers.providerList[0].value,
                fork: props.providers.providerList[0].fork,
              });
            }, 2000)
          : null}
        <Dropdown
